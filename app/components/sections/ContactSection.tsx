  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-[#20293A]">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">Get In <span className="text-[#C6F10E]">Touch</span></h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Left Column - Contact Info & Map (Desktop) */}
          <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">contact@sabidzpro.is-a.dev</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">+62 822-4203-4791</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">Indonesia</p>
                  </div>
                </div>
              </div>
            ...
            <div className="hidden lg:block bg-[#19222D] p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4">Find Me Here</h3>
              <GoogleMapComponent 
                center={{ lat: -7.9288452, lng: 110.8288609 }}
                zoom={16}
                markerPosition={{ lat: -7.9288452, lng: 110.8288609 }}
                markerTitle="SS Sabidz Shop"
                markerDescription="Saiful Abidin's Location"
              />
            </div>
          </div>
        ...
        {/* Interactive Map - Mobile Only (Bottom) */}
