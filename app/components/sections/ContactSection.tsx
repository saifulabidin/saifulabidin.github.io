      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5">
            <div className="bg-[#19222D] p-6 rounded-lg shadow-lg mb-8">
              <h3 className="text-2xl font-semibold mb-6">Let's Connect</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#C6F10E] rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">contact@sabidzpro.is-a.dev</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+62 822-4203-4791</p>
                  </div>
                </div>
