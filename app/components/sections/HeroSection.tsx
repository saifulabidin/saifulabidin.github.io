...
export default function HeroSection() {
  return (
    <section id="home" className="pt-20 pb-10 md:pb-0">
      <div className="container mx-auto px-4 min-h-screen flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-0 w-full min-h-[calc(100vh-5rem)]">
          {/* Lanyard Model - Hidden on mobile, shown on desktop */}
          ...
          <div className="col-span-1 md:col-span-6 flex items-center justify-center w-full">
            <div className="flex flex-col gap-6 md:gap-8 text-center md:text-left max-w-lg md:max-w-none mx-auto md:mx-0">
              ...
              <div className="flex flex-col items-center md:items-start space-y-2">
                <SplitText
                  ...
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center md:text-start leading-tight"
                  delay={50}
                ...
                <SplitText
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-start text-[#C6F10E] leading-tight"
                  delay={75}
                  animationFrom={{ opacity: 0, transform: 'translate3d(0,50px,0)' }}
                  animationTo={{ opacity: 1, transform: 'translate3d(0,0,0)' }}
                  threshold={0.2}
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-6 py-6 border-y border-gray-700/50 mb-4">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#C6F10E]">5+</div>
                ...
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#C6F10E]">100%</div>
                  <div className="text-sm sm:text-base text-gray-400 mt-1">Client Satisfaction</div>
                </div>
              </div>
              ...
              <div className="flex justify-center md:justify-start items-center gap-4 -mt-2">
                <span className="text-gray-400 text-sm font-medium hidden md:block">Follow me:</span>
                <div className="flex items-center gap-4">
                  <a 
                    href="https://github.com/saifulabidin" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="group flex items-center justify-center w-10 h-10 rounded-full bg-gray-800/50 hover:bg-[#C6F10E]/10 border border-gray-700/50 hover:border-[#C6F10E]/50 text-gray-400 hover:text-[#C6F10E] transition-all duration-300 transform hover:scale-110"
                    title="GitHub"
                  >
                  ...
                  <a 
                    href="https://linkedin.com/in/saiful-abidin" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="group flex items-center justify-center w-10 h-10 rounded-full bg-gray-800/50 hover:bg-[#C6F10E]/10 border border-gray-700/50 hover:border-[#C6F10E]/50 text-gray-400 hover:text-[#C6F10E] transition-all duration-300 transform hover:scale-110"
                    title="LinkedIn"
                  ...
                  <a 
                    href="https://instagram.com/itssabidz" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="group flex items-center justify-center w-10 h-10 rounded-full bg-gray-800/50 hover:bg-[#C6F10E]/10 border border-gray-700/50 hover:border-[#C6F10E]/50 text-gray-400 hover:text-[#C6F10E] transition-all duration-300 transform hover:scale-110"
                    title="Instagram"
